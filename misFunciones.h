...
void reglas(int puntajeMayor[3], string nombreDelMayorPuntaje[3]); /// PAGINA CON LA REGLAMENTACION
void menu(int puntajeMayor[3], string nombreDelMayorPuntaje[3]); /// PAGINA DE MENU
...
void Simulacion(int puntajeMayor[3], string nombreDelMayorPuntaje[3]);  /// PAGINA DE SIMULACION
